...
import 'package:straightforwardclasses/screen/ignou/council/coucilCideo.dart';
...
class _biharTeacherState extends State<council> {
  ...
  void initState() {
    ...
    // ignore: deprecated_member_use
    _videoRef = database.reference().child('Counselling');
    super.initState();
  }
