...
import 'package:straightforwardclasses/screen/four.dart/BED_Study_Material.dart';
...
class fourhome extends StatefulWidget {
  @override
...
class _ignouScreenState extends State<fourhome> {
          ...
          Padding(
            ...
            child: InkWell(
              ...
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => BED_Study_Material()),
                );
              },
            ),
          ),
