...
class foursub extends StatefulWidget {
  @override
  _subscriptionState createState() => _subscriptionState();
}

class _subscriptionState extends State<foursub> {
  ...
  final cities = FirebaseFirestore.instance.collection("DELED_BED");
  ...
  Future<void> _handlePaymentSuccess(PaymentSuccessResponse response) async {
    ...
    Navigator.pushAndRemoveUntil(
      context,
      MaterialPageRoute(builder: (context) => fourhome()),
