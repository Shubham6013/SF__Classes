...
import 'package:straightforwardclasses/screen/four.dart/fourfourscreen.dart';
import 'package:straightforwardclasses/screen/four.dart/video4.dart';
...
class _biharTeacherState extends State<four> {
  ...
  void initState() {
    ...
    // ignore: deprecated_member_use
    _videoRef = database.reference().child('DELED_BED');
    super.initState();
  }
