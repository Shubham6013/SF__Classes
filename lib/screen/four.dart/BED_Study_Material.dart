...
class BED_Study_Material extends StatefulWidget {
  @override
  _biharTeacherState createState() => _biharTeacherState();
}

class _biharTeacherState extends State<BED_Study_Material> {
  ...
  void initState() {
    ...
    // ignore: deprecated_member_use
    _videoRef = database.reference().child('DELED_BED_Study_Material');
    super.initState();
  }
