...
import 'package:straightforwardclasses/screen/notification/noti-screen.dart';
import 'package:straightforwardclasses/screen/notification/videonoti.dart';
...
class _biharTeacherState extends State<noti> {
  ...
  void initState() {
    ...
    // ignore: deprecated_member_use
    _videoRef = database.reference().child('Notifications');
    super.initState();
  }
