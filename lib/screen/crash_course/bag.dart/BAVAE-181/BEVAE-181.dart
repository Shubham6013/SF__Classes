...
class _ignouScreenState extends State<one> {
...
class _biharTeacherState extends State<videosss> {
  ...
  void initState() {
    ...
    // ignore: deprecated_member_use
    _videoRef = database.reference().child('BEVAE-181');
    super.initState();
  }
...
class _subscriptionState extends State<ones> {
  ...
  final cities = FirebaseFirestore.instance.collection("BEVAE-181");
