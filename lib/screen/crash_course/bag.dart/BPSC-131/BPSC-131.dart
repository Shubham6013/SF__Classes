...
class _ignouScreenState extends State<eleven> {
...
class _biharTeacherState extends State<videosss> {
  ...
  void initState() {
    ...
    // ignore: deprecated_member_use
    _videoRef = database.reference().child('BPSC-131');
    super.initState();
  }
...
class elevens extends StatefulWidget {
  @override
  _subscriptionState createState() => _subscriptionState();
}

class _subscriptionState extends State<elevens> {
  ...
  final cities = FirebaseFirestore.instance.collection("BPSC-131");
