...
class _ignouScreenState extends State<three> {
...
class _biharTeacherState extends State<videosss> {
  ...
  void initState() {
    ...
    // ignore: deprecated_member_use
    _videoRef = database.reference().child('BEGLA-135');
    super.initState();
  }
...
class threes extends StatefulWidget {
  @override
  _subscriptionState createState() => _subscriptionState();
}

class _subscriptionState extends State<threes> {
  ...
  final cities = FirebaseFirestore.instance.collection("BEGLA-135");
