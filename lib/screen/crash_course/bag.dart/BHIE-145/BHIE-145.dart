...
class tenn extends StatefulWidget {
  @override
...
class _ignouScreenState extends State<tenn> {
...
class _biharTeacherState extends State<videosss> {
  ...
  void initState() {
    ...
    // ignore: deprecated_member_use
    _videoRef = database.reference().child('BHIE-145');
    super.initState();
  }
...
class tenns extends StatefulWidget {
  @override
  _subscriptionState createState() => _subscriptionState();
}

class _subscriptionState extends State<tenns> {
  ...
  final cities = FirebaseFirestore.instance.collection("BHIE-145");
