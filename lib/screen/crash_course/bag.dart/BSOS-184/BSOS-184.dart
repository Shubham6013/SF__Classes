...
class _ignouScreenState extends State<thirteen> {
...
class _biharTeacherState extends State<videosss> {
  ...
  void initState() {
    ...
    // ignore: deprecated_member_use
    _videoRef = database.reference().child('BSOS-184');
    super.initState();
  }
...
class thirteens extends StatefulWidget {
  @override
  _subscriptionState createState() => _subscriptionState();
}

class _subscriptionState extends State<thirteens> {
  ...
  final cities = FirebaseFirestore.instance.collection("BSOS-184");
