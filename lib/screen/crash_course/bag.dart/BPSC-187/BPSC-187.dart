...
class _ignouScreenState extends State<twelve> {
...
class _biharTeacherState extends State<videosss> {
  ...
  void initState() {
    ...
    // ignore: deprecated_member_use
    _videoRef = database.reference().child('BPSC-187');
    super.initState();
  }
...
class twelves extends StatefulWidget {
  @override
  _subscriptionState createState() => _subscriptionState();
}

class _subscriptionState extends State<twelves> {
  ...
  final cities = FirebaseFirestore.instance.collection("BPSC-187");
