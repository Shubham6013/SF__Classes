...
class _ignouScreenState extends State<two> {
...
class _biharTeacherState extends State<videosss> {
  ...
  void initState() {
    ...
    // ignore: deprecated_member_use
    _videoRef = database.reference().child('BEGAE-182');
    super.initState();
  }
...
class twos extends StatefulWidget {
  @override
  _subscriptionState createState() => _subscriptionState();
}

class _subscriptionState extends State<twos> {
  ...
  final cities = FirebaseFirestore.instance.collection("BEGAE-182");
