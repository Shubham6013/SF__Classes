...
class _ignouScreenState extends State<nine> {
...
class _biharTeacherState extends State<videosss> {
  ...
  void initState() {
    ...
    // ignore: deprecated_member_use
    _videoRef = database.reference().child('BHIE-143');
    super.initState();
  }
...
class nines extends StatefulWidget {
  @override
  _subscriptionState createState() => _subscriptionState();
}

class _subscriptionState extends State<nines> {
  ...
  final cities = FirebaseFirestore.instance.collection("BHIE-143");
