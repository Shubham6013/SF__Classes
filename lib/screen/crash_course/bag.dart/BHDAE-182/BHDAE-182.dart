...
class _ignouScreenState extends State<four> {
...
class _biharTeacherState extends State<videosss> {
  ...
  void initState() {
    ...
    // ignore: deprecated_member_use
    _videoRef = database.reference().child('BHDAE-182');
    super.initState();
  }
...
class _subscriptionState extends State<fours> {
  ...
  final cities = FirebaseFirestore.instance.collection("BHDAE-182");
