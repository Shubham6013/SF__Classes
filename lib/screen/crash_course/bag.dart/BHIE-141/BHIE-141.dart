...
class _ignouScreenState extends State<eight> {
...
class _biharTeacherState extends State<videosss> {
  ...
  void initState() {
    ...
    // ignore: deprecated_member_use
    _videoRef = database.reference().child('BHIE-141');
    super.initState();
  }
...
class _subscriptionState extends State<eights> {
  ...
  final cities = FirebaseFirestore.instance.collection("BHIE-141");
