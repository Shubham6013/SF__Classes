...
import 'package:straightforwardclasses/screen/cuet/Test3.dart';
import 'package:straightforwardclasses/screen/cuet/seeAll.dart';
...
class cuet extends StatefulWidget {
  @override
  _biharTeacherState createState() => _biharTeacherState();
}

class _biharTeacherState extends State<cuet> {
  ...
  void initState() {
    ...
    // ignore: deprecated_member_use
    _videoRef = database.reference().child('Delhi_Principal_Exam');
    super.initState();
  }
